...
public class Legend extends JPanel {
	...
	/** servialVersionUID is a value that is used for this class */
	private static final long serialVersionUID = 1L;
	
	/** an array of colors used for representing different carts */
	private Color[] hue = Simulator.simulationColors();
	
	/** An array of simulation labels used in simulation */
	...
	private class ColorTableModel extends AbstractTableModel {
		...
		/** 2D array of content used for descriptions */
