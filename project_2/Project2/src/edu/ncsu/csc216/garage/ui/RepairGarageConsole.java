...
/**
 * Simple commmand-line interface for a auto service garage. (There is no code
 * to correct the placement of the cursor.) The file "cars.txt" can serve as a
...
public class RepairGarageConsole {
	...
	/**
	 * Creates a new console with vehicle wait list drawn from "cars.txt" and 8
	 * service bays. If "cars.txt" is not available, the patient list is
	 * initially empty
	 */
	...
	public void run() {
		...
		case 1: // Admit a new vehicle to the wait list
			...
			break;
		case 2: // Remove a vehicle from the wait list. The position is relative
				// to the filter
	...
	public static void main(String[] args) {
		System.out.println(
				"Use this simple application to do preliminary functional testing on the Service Garage project.\n "
